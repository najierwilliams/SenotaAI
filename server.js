...
var HRA_COORDINATE_SPACES = {
  ...
  "allen-human-reference-atlas-3d-2020-icbm-2009b-sym": {
    ...
    units: HRA_SPATIAL_UNITS,
    coordinateConvention: "Official Allen v1.0.0 annotation NIfTI qform: 0.5 mm isotropic RAS voxel axes with world origin (-98, -134, -72) mm.",
    provenanceUrl: "https://download.alleninstitute.org/informatics-archive/allen_human_reference_atlas_3d_2020/version_1/",
    scientificUse: "Verified annotation/reference frame only. No raw GLB-to-annotation correspondence or executable Luna/HRA-to-ICBM 2009b transform is established."
  },
...
// shared/hraSpatial/AllenIcbm2009bEvidence.ts
var annotationBaseUrl = "https://download.alleninstitute.org/informatics-archive/allen_human_reference_atlas_3d_2020/version_1";
var sharedAnnotationEvidence = {
...
var ALLEN_ICBM_2009B_CORRESPONDENCE_EVIDENCE = {
  ...
  referenceDataset: {
    ...
    externalTemplate: {
      ...
      officialArchiveUrl: "https://www.bic.mni.mcgill.ca/~vfonov/icbm/2009/mni_icbm152_nlin_sym_09b_nifti.zip",
      archiveApproximateSize: "348 MB",
      retrieved: false,
      reasonNotRetrieved: "The official Allen annotation header already establishes its image frame; the unresolved scientific issue is GLB-to-annotation provenance, which a template download cannot resolve."
    }
  },
  annotationVolumes: [
    {
      ...
      sha256: "2b05581e39c44f2623d9b0a69f64e3df0823c20d054abef92973812313335dc3",
      bytes: 1815762,
      description: "Official bilateral Allen annotation volume generated by the release's documented mirror workflow."
    },
    {
      ...sharedAnnotationEvidence,
      filename: "annotation.nii.gz",
      sha256: "be23763c15386f2f211105f1e8144a6887e7615571229090e209b1c78355d378",
      bytes: 1117842,
      description: "Official original Allen annotation volume used by the release's documented mirror example."
    }
  ],
  semanticStructureCandidates: [
    {
      ...
      limitation: "The names align with the official Allen label table, but no GLB node-to-voxel-label or surface-generation artifact is published."
    },
    {
      glbNodeNames: [
      ...
      laterality: "paired",
      evidence: "exact-name-semantic-candidate",
      limitation: "Semantic identity only; no vertex-to-voxel correspondence is available."
    },
    {
      glbNodeNames: [
    ...
    },
    {
      ...
      laterality: "paired",
      evidence: "exact-name-semantic-candidate",
      limitation: "Semantic identity only; no coordinate relation is supplied by either source."
    },
    {
    ...
    },
    {
      ...
      laterality: "midline",
      evidence: "exact-name-semantic-candidate",
      limitation: "The source names share the anatomical label but do not supply a mesh-to-label mapping or a midline landmark validation."
    }
  ],
