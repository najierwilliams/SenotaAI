...
export default function LunaFoundation() {
  ...
  const [form, setForm] = useState({ name: "Luna", currentAge: 0, nativeLanguage: "English", personalityFoundation: "", personalityKnowledge: "", appearanceReference: "" });
  useEffect(() => {
    if (!selfState) return;
