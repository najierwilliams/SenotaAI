...
import { Bot, BrainCircuit, History, LayoutDashboard, LogOut, PanelLeft, Plus, Settings } from "lucide-react";
...
const menuItems = [
  ...
  { icon: Plus, label: "New task", path: "/new" },
  { icon: History, label: "Task history", path: "/history" },
  { icon: BrainCircuit, label: "Agent memory", path: "/memory" },
