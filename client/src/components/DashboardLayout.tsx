  ...
  return (
    <>
      <div className="relative" ref={sidebarRef}>
        <Sidebar
          collapsible="icon"
          className="border-r border-white/10 bg-sidebar/95"
        ...
        >
                ...
                return (
                  <SidebarMenuItem key={item.path}>
                    <SidebarMenuButton
                      ...
                      tooltip={item.label}
                      className={`h-10 rounded-xl transition-all font-medium ${isActive ? "bg-cyan-300/10 text-cyan-100" : "text-slate-400 hover:bg-white/5 hover:text-slate-100"}`}
                    >
                      <item.icon
          ...
          <SidebarFooter className="p-3">
            <div className="flex items-center gap-3 rounded-lg px-2 py-2 text-slate-400 group-data-[collapsible=icon]:justify-center">
              <div className="grid size-8 place-items-center rounded-lg bg-cyan-300/10 text-cyan-300"><Bot className="size-4" /></div>
              <div className="group-data-[collapsible=icon]:hidden">
                <p className="text-sm font-medium text-slate-200">Direct workspace</p>
                <p className="mt-0.5 text-xs text-slate-500">No sign-in required</p>
              </div>
            </div>
          </SidebarFooter>
        </Sidebar>
