...
export async function recordNpcAdminAudit(action: string, recordType: "canon" | "memory" | "relationship" | "cognitive-state" | "cognitive-memory" | "cognitive-belief" | "cognitive-goal" | "cognitive-relationship" | "cognitive-observation" | "cognitive-reflection" | "agent-state" | "agent-event" | "agent-outcome", recordId: string, fields: string[]) {
