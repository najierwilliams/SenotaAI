...
export const BRAIN_REFERENCE_SPACES: BrainReferenceSpace[] = [
  ...
  },
  {
    ...
    kind: "template",
    provider: "ebrains",
    template: "MNI 152 ICBM 2009c Nonlinear Asymmetric",
    units: "millimetres",
    providerNativeUnits: "micrometres",
    axisOrientation: null,
    handedness: null,
    origin: null,
    providerReferenceSpaceId: "minds/core/referencespace/v1.0.0/dafcffc5-4826-4bf1-8ff6-46b8a31ff8e2",
    retrievedAt: "2026-08-26",
    coordinateConvention: "Explicit MNI stereotaxic query coordinates in MNI ICBM 152 2009c Nonlinear Asymmetric. Luna accepts user-entered provider queries in millimetres; siibra metadata reports micrometres as the provider-native unit. Axis orientation, handedness, and origin are not documented by the reviewed provider metadata and remain unknown.",
    resolution: "1 × 1 × 1 mm",
    version: "MNI 152 ICBM 2009c Nonlinear Asymmetric",
    provenanceUrl: "https://siibra-api-stable.apps.hbp.eu/v3_0/spaces?size=100",
    description:
      "Canonical provider-declared scientific reference space for independently entered Luna scientific queries. It is not a coordinate frame for the HRA presentation GLB.",
  },
  {
    id: "ebrains-bigbrain",
    label: "BigBrain microscopic template (histology)",
    kind: "histological",
    provider: "bigbrain",
    template: "BigBrain microscopic template (histology)",
    units: "micrometres",
    providerNativeUnits: "micrometres",
    axisOrientation: null,
    handedness: null,
    ...
    retrievedAt: "2026-08-26",
    coordinateConvention: "Provider BigBrain histological coordinates. Axis orientation, handedness, and origin remain unknown because the reviewed provider metadata did not state them. No BigBrain-to-MNI transform is executable in Luna; only provider context is exposed until a checksum-bound, validated artifact and acceptable licence are retained.",
    resolution: "20 μm",
    version: "BigBrain microscopic template (histology)",
    provenanceUrl: "https://siibra-api-stable.apps.hbp.eu/v3_0/spaces?size=100",
    description:
      "Microscopic 20 μm histological reference represented in the EBRAINS multilevel atlas. It remains distinct from MNI and Luna Local.",
  },
  {
...
export const BRAIN_DATASETS: BrainDataset[] = [
  ...
  },
  {
    ...
    license: "CC BY-NC-SA 4.0; Luna exposes provider context only and does not download, stream, bundle, transform, cache, or redistribute BigBrain assets.",
    citation:
    ...
    description:
      "A microscopic provider reference discoverable through the EBRAINS ecosystem. Luna exposes reference context only; no BigBrain visual asset, volume, transform, or derived map is loaded.",
    limitations:
      "The full source dataset is too large for GitHub and browser payloads. Luna does not download, cache, stream, render, transform, or redistribute the raw volume or any derivative.",
  },
  {
